...
newdiv.setAttribute("margin-left","40px");
newdiv.setAttribute("border","solid 2px red");
newdiv.innerHTML="<h3 style='font-family:serif;'>ADD NEW PRODUCT</h3><hr style='width:60px;'>";

newdiv.innerHTML=newdiv.innerHTML+"<form method='POST' enctype='multipart/form-data' id='fileUploadForm'><table><tr><th STYLE='FONT-FAMILY:serif;'>Product Name:</th><td><input type='text' style='border-radius:10px;height=30px;' id='pname'></td></tr><tr><th STYLE='FONT-FAMILY:serif;'>Product Type:</th><td><input type='text' style='border-radius:10px;' id='ptype'></td></tr><tr><th STYLE='FONT-FAMILY:serif;'>Product Price:</th><td><input type='text' style='border-radius:10px;height=30px;' id='pprice'></td></tr><tr><th STYLE='FONT-FAMILY:serif;'>Product Desc:</th><td><input type='text' style='border-radius:10px;height=30px;' id='pdesc'></td></tr><tr><td colspan='2'><input type='file' style='border-radius:10px;height=30px;' name='files' value='Select Image'></td></tr><tr><th><input type='button' value='Add Product' onclick='addProduct()' id='addprd'></th><th><input type='reset' value='Clear' onclick='clearText()'></th></tr></table></form>";
...
function viewOrders()
{
    ...
    var newdiv=document.createElement("div");
       ...
       newdiv.setAttribute("border","solid 2px red");
       newdiv.innerHTML="<h3 style='font-family:serif;'>VIEW ALL ORDERS</h3><hr style='width:60px;'>";
...
newdiv.setAttribute("padding-left","12px");
newdiv.setAttribute("border","solid 2px red");
newdiv.innerHTML="<h3 STYLE='FONT-FAMILY:serif;'>REMOVE USER</h3><hr style='width:60px;'>";
newdiv.innerHTML=newdiv.innerHTML+"<form method='POST' id='fileUploadForm'><table ><tr><th style='font-family:serif'>Username:</th><td><select id='userName' name='dropdown'></select></tr><br><tr><th><input type='button' style='text-align:center;' value='Remove' onclick='removeUser()' id='removeuser'></th></table></form>";
newdiv.innerHTML=newdiv.innerHTML+"<span id='addresp'></span>";
var addPrd=$("#productcontainer")[0];
addPrd.appendChild(newdiv);
$("#productform").hide();
...
newdiv.setAttribute("padding-left","12px");
newdiv.setAttribute("border","solid 2px red");
newdiv.innerHTML="<h3 STYLE='FONT-FAMILY:serif;'>UPDATE PRODUCT</h3><hr style='width:60px;'>";
newdiv.innerHTML=newdiv.innerHTML+"<form method='POST' enctype='multipart/form-data' id='fileUploadForm'><table><tr><th STYLE='FONT-FAMILY:serif;'>Product Id:</th><td><select id='optionId' name='dropdown'></select></tr><tr><th STYLE='FONT-FAMILY:serif;'>Product Name:</th><td><input type='text' style='border-radius:10px;height=30px;' id='pname'></td></tr><tr><th STYLE='FONT-FAMILY:serif;'>Product Type:</th><td><input type='text' style='border-radius:10px;height=30px;' id='ptype'></td></tr><tr><th STYLE='FONT-FAMILY:serif;'>Product Price:</th><td><input type='text' style='border-radius:10px;height=30px;' id='pprice'></td></tr><tr><th STYLE='FONT-FAMILY:serif;'>Product Desc:</th><td><input type='text' style='border-radius:10px;height=30px;' id='pdesc'></td></tr><tr><td colspan='2'><input type='file' name='files' value='Select Image'></td></tr><tr><th  colspan='2'><input type='button' value='Update Product' onclick='updateProduct()' id='updateprd'></th></tr></table><span id='itemImage'></span></form>";
newdiv.innerHTML=newdiv.innerHTML+"<span id='addresp'></span>";
var addPrd=$("#productcontainer")[0];
addPrd.appendChild(newdiv);
$("#productform").hide();
...
newdiv.setAttribute("padding-left","12px");
newdiv.setAttribute("border","solid 2px red");
newdiv.innerHTML="<h3 STYLE='FONT-FAMILY:serif;'>DELETE PRODUCT</h3><hr style='width:60px;'>";
newdiv.innerHTML=newdiv.innerHTML+"<form method='POST'  id='fileUploadForm'><table><tr><th STYLE='FONT-FAMILY:serif;'>Product Id:</th><td><select id='optionId' name='dropdown'></select></tr><tr><th STYLE='FONT-FAMILY:serif;'>Product Name:</th><td><input type='text' style='border-radius:10px;height=30px;' id='pname'></td></tr><tr><th STYLE='FONT-FAMILY:serif;'>Product Type:</th><td><input type='text' style='border-radius:10px;height=30px;' id='ptype'></td></tr><tr><th STYLE='FONT-FAMILY:serif;'>Product Price:</th><td><input type='text' style='border-radius:10px;height=30px;' id='pprice'></td></tr><tr><th STYLE='FONT-FAMILY:serif;'>Product Desc:</th><td><input type='text' style='border-radius:10px;height=30px;' id='pdesc'></td></tr><tr><th colspan='2'><input align='center' type='button' value='Delete Product' onclick='deleteProduct()' id='deleteprd'></th></tr></table><span id='itemImage'></span></form>";
newdiv.innerHTML=newdiv.innerHTML+"<span id='addresp'></span>";
var addPrd=$("#productcontainer")[0];
addPrd.appendChild(newdiv);
$("#productform").hide();
